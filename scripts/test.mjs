...
async function main() {
  ...
  const testFiles = [
    ...
    "extractors.test.js", "correlation.test.js", "run-services.test.js", "proposal.test.js", "multi-repository-contract.test.js", "ai.test.js", "documentation.test.js", "publication.test.js", "cli.test.js", "security.test.js"
