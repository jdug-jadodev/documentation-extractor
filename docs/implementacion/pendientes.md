...
- Tipos, compilación y suite automatizada: 52/52 pruebas superadas.
...
- MCP comprobado con once herramientas; `docsys_explain_service` y `docsys_explain_endpoint` exponen contexto compacto precalculado sin reanalizar.
...
- Confirmar permisos y política de parches en el propio PC empresarial; la versión exacta Node 20.19.5 ya pasó tipos, build, 46/46 pruebas y smoke MCP local.
