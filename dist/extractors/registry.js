...
export function builtInPlugins() { return [createSourceArchitecturePlugin(), createDotnetPlugin(), createJavaSpringPlugin(), createJavaWeblogicPlugin(), createAngularPlugin(), createReactPlugin(), createNodeExpressPlugin(), createPythonPlugin()]; }
