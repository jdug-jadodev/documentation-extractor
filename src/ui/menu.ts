...
export async function showMainMenu(config: EffectiveConfiguration): Promise<MenuAction> {
  ...
  try {
    ...
    const actions: Record<string, MenuAction> = { "1": "update-one", "2": "update-many", "3": "relation", "4": "flow", "5": "proposal", "6": "query", "7": "document", "8": "open", "9": "configure", "0": "exit" };
