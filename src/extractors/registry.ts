...
export function builtInPlugins(): ExtractorPlugin[] { return [createDotnetPlugin(), createJavaSpringPlugin(), createJavaWeblogicPlugin(), createAngularPlugin(), createReactPlugin(), createPythonPlugin()]; }
