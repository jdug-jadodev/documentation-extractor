...
export interface SchedulerInstructions { windows: string[]; unix: string[]; notes: string[]; }
export function schedulerInstructions(packageRoot: string, configPath: string): SchedulerInstructions {
